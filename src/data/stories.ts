...
export const LOCATION_STORIES: Record<string, LocationStory> = {
  ...
  "hutiaoxia": {
    facets: {
      nature: [
        l("虎跳峡长约十六公里，江面宽处六十至八十米，最窄处只剩三十米上下；而从水面抬头，玉龙雪山五千五百九十六米、哈巴雪山五千三百九十六米，高差近三千八百米。两岸是片岩与大理岩，江水在峡中还要再跌两百多米。", "Tiger Leaping Gorge runs about sixteen kilometres. The channel is sixty to eighty metres wide, narrowing to some thirty, while from the water to the summits — Jade Dragon Snow Mountain at 5,596 metres, Haba at 5,396 — the relief approaches 3,800 metres. The walls are schist and marble, and inside the gorge itself the river drops a further two hundred metres and more.", "虎跳峡は全長およそ一六キロ。川幅は広いところで六〇〜八〇メートル、最も狭いところでは三〇メートルほどしかない。水面から見上げれば、玉龍雪山は五五九六メートル、哈巴雪山は五三九六メートル、その高低差は三八〇〇メートル近い。両岸は片岩と大理石。峡谷のなかだけで、水はさらに二〇〇メートル以上を落ちる。"),
  ...
  "jinshajiang": {
    facets: {
      ...
      culture: [
        ...
        l("迪庆藏族自治州两万三千余平方公里，人口不足三十九万，藏族约占三成、傈僳族约二成七，地势从澜沧江边一千四百八十六米一直抬到梅里雪山卡瓦格博峰六千七百四十米。一个州里装着从河谷到雪线的全部气候，也装着好几种活法。", "Diqing Tibetan Autonomous Prefecture covers 23,186 square kilometres and holds fewer than 390,000 people — about a third Tibetan, a quarter Lisu. The land climbs from 1,486 metres at the Lancang's confluence to 6,740 metres at Kawagebo on the Meili range. One prefecture contains every climate from valley floor to snowline, and as many ways of living.", "迪慶チベット族自治州は二万三一八六平方キロ、人口は三九万に満たない。チベット族が約三割、リス族が約二割七分を占める。土地は瀾滄江との合流点の一四八六メートルから、梅里雪山カワクボ峰の六七四〇メートルまで駆け上がる。ひとつの州のなかに、谷底から雪線までのすべての気候が、そして幾通りもの生き方が収まっている。"),
  ...
  "nanjing": {
    facets: {
      history: [
        ...
        l("1368年，朱元璋在此登基。二十万工匠花了二十一年，沿山势起伏砌出一圈城墙——不求方正，只顺地形。2005年实测，京城城墙周长35.267公里；今天还立着约二十五公里，仍是这座城市最结实的骨架。", "In 1368 Zhu Yuanzhang was enthroned here as the Hongwu Emperor. Two hundred thousand labourers spent twenty-one years laying a wall that refuses to be a square: it climbs and dips with the hills. A 2005 survey put the capital wall at 35.267 km; some twenty-five of those kilometres still stand, and they remain the city's hardest bone.", "1368年、朱元璋はこの地で帝位に就いた。二十万の人夫が二十一年をかけて築いた城壁は、方形の理想を捨てて山の起伏にそのまま従う。2005年の実測で京城の周囲は三五・二六七キロ、うち約二十五キロが今も立ち、この街のいちばん硬い骨であり続けている。"),
  ...
  "panxi": {
    facets: {
      ...
      culture: [
        l("凉山彝族自治州六万零二百六十一平方公里，人口四百八十六万，彝族约占五成二，是诺苏彝语的核心地带。地势从谷底三百零五米一直抬到木里境内最高的五千九百五十八米——五千六百米的高差里，装着从干热河谷到雪线的所有活法。", "Liangshan Yi Autonomous Prefecture covers 60,261 square kilometres and holds 4.86 million people, about 52 per cent of them Yi; this is the heartland of Nuosu. The land climbs from 305 metres on the valley floor to 5,958 at the highest summit in Muli — five and a half kilometres of relief holding every way of life from dry-hot gorge to snowline.", "涼山イ族自治州は六万〇二六一平方キロ、人口四八六万。うち約五二パーセントがイ族で、ここはノス（諾蘇）方言の中心地である。土地は谷底の三〇五メートルから、木里の最高峰五九五八メートルまで駆け上がる。五六〇〇メートルの高低差のなかに、乾熱河谷から雪線までのあらゆる暮らしが収まっている。"),
  ...
  "shanghai": {
    facets: {
      nature: [
        l("崇明岛是长江写下的最后一段字。唐武德年间（六一八至六二六），江口浮出东沙、西沙两块沙洲，此后千余年不断并接、涨坍；到2010年，全岛面积已达一千二百六十七平方公里，是中国第三大岛。", "Chongming is the last line the Yangtze writes. In the Wude years of the Tang (618–626) two shoals, Dongsha and Xisha, broke the surface at the river mouth; for a thousand years afterwards they joined, grew, and were eaten back again. By 2010 the island covered 1,267 km², the third largest in China.", "崇明島は、長江が最後に書きつける一行である。唐の武徳年間（六一八〜六二六）、河口に東沙・西沙という二つの砂州が浮かび、以後千年あまり、くっつき、伸び、また削られてきた。2010年時点の面積は一二六七平方キロ。中国で三番目に大きい島である。"),
        ...
        l("不过账目已经变了。2003年以后，三角洲前缘出现明显侵蚀，沉积物也在变粗——上游拦住的沙，不再送到这里来。六千三百公里的旅程仍在继续，只是它带下来的东西，比从前少了。", "The ledger, though, has changed. Since 2003 the delta front has been eroding markedly and its sediments coarsening: the sand held back upstream no longer arrives. The 6,300-kilometre journey still ends here — it simply brings less with it than it used to.", "ただ、帳尻は変わってしまった。2003年以降、三角州の前縁では明らかな侵食が進み、堆積物も粗くなっている。上流でせき止められた砂が、もうここまで届かない。六三〇〇キロの旅は今も続く。ただ、運んでくるものが以前より少ないだけだ。"),
      ],
      history: [
        l("上海起初只是江海之间的渔村与市镇。唐代先后设青龙镇（七四六）与华亭镇（七五一）；1074年宋神宗在此置市舶与榷货机构；1291年五个村庄并为上海县，人口约三十万。它是靠一个水口做生意起家的。", "Shanghai began as fishing villages and market towns between river and sea. The Tang set the garrison of Qinglong here in 746 and Huating in 751; in 1074 Emperor Shenzong of Song established a maritime trade office and a goods control bureau; in 1291 five villages were amalgamated into Shanghai County, with a population of roughly 300,000. From the very start it made its living at a river mouth.", "上海はもともと、川と海のあいだの漁村と市であった。唐は746年に青龍鎮、751年に華亭鎮を置き、1074年には宋の神宗がここに市舶と榷貨の役所を設けた。1291年、五つの村がまとめられて上海県となる。人口はおよそ三十万。この街は最初から、河口で商売をして生きてきた。"),
      ...
      culture: [
        ...
        l("长江三角洲住着一亿两千三百万人（2020年），贡献了全国约百分之十七的经济产出（2024年）。高原上的一捧雪水走了六千三百公里，最后落进集装箱吊车的阴影里——到这里，这条河把故事交给了海。", "The Yangtze Delta holds 123 million people (2020) and produces about seventeen per cent of China's economic output (2024). A handful of snowmelt off the plateau has travelled 6,300 kilometres to end in the shadow of container cranes. Here the river hands the story over to the sea.", "長江デルタには一億二三〇〇万人が暮らし（2020年）、中国の経済産出のおよそ一七パーセントを生んでいる（2024年）。高原の雪解け水ひとすくいが六三〇〇キロを旅して、コンテナクレーンの影の下に落ちる。ここで長江は、その物語を海へ手渡す。"),
      ],
    },
    links: [
      {
  ...
  "tongtianhe": {
    facets: {
      nature: [
        l("沱沱河与当曲在青海腹地相汇，从此改称通天河。这一段长八百一十三公里，走在海拔四千五百米上下的高原上，河谷开阔，水流平缓，河道分了又合、合了又分。它不像峡谷里的江，倒像一片恰好在移动的水面。", "Where the Tuotuo meets the Dangqu deep in Qinghai, the river takes a new name: Tongtian, the river that reaches the sky. For 813 kilometres it crosses a plateau at around 4,500 metres, its valley broad, its current unhurried, its channels dividing and rejoining and dividing again. It behaves less like a river in a gorge than like a sheet of water that happens to be moving.", "沱沱河と当曲が青海の奥地で合わさると、川は名を変えて通天河となる。この八一三キロは標高四五〇〇メートル前後の高原を行き、谷は広く、流れはゆるやかで、流路は分かれては合わさり、また分かれる。峡谷を流れる川というより、たまたま動いている水面がそこにある、と言うほうが近い。"),
        l("通天河止于玉树的巴塘河口，那里海拔约三千五百米。八百多公里只落下一千米，平均每公里一米出头——大江在这里几乎是躺着走的。出了巴塘河口它才改名金沙江，随即开始那场两千三百公里、落差三千二百五十米的俯冲。", "The Tongtian ends at the mouth of the Batang River near Yushu, at about 3,500 metres. Eight hundred kilometres for a thousand metres of fall — barely a metre per kilometre. Up here the great river is almost lying down. Only past Batang does it become the Jinsha, and begin the 2,300-kilometre plunge that will take another 3,250 metres out from under it.", "通天河は玉樹の巴塘河口、標高およそ三五〇〇メートルで終わる。八〇〇キロ余りを流れて落差は一〇〇〇メートル、一キロあたり一メートル強にすぎない。大河はここではほとんど横たわって進んでいる。巴塘河口を過ぎてはじめて金沙江と名を変え、二三〇〇キロで三二五〇メートルを落ちる急降下が始まる。"),
      ],
      history: [
        l("唐蕃古道东起长安，西至逻些，全长三千余公里，跨今陕、甘、青、川、藏五省区。它翻过巴颜喀拉山，西渡通天河，经玉树结古、巴塘，再越唐古拉山口进入吐蕃腹地。对走这条路的人来说，通天河不是风景，是一道必须解开的题。", "The Tang–Tibet road ran more than 3,000 kilometres from Chang'an to Lhasa, across what are now five provinces. It climbed the Bayan Har range, forded the Tongtian westward, passed through Jiegu and Batang in Yushu, and only then crossed the Tanggula pass into central Tibet. To anyone walking that road, the Tongtian was not scenery. It was a problem that had to be solved.", "唐蕃古道は長安に発し、逻些（ラサ）に至る三〇〇〇キロを超える道で、今日の陝西・甘粛・青海・四川・チベットの五省区にまたがる。巴顔喀拉（バヤンカラ）山脈を越え、通天河を西へ渡り、玉樹の結古・巴塘を経て、唐古拉峠を越えて吐蕃の中心へ入る。この道を行く者にとって通天河は景色ではなく、必ず解かねばならぬ一問だった。"),
        l("641年，文成公主自长安西行入蕃，这条和亲之路自此以「唐蕃古道」之名传世。此后两百余年往还不绝：六三四至850年间，蕃使至唐一百二十五次，唐使入蕃六十五次。茶、绢、经卷、工匠与马匹，都从这条河的渡口上过。", "In 641 Princess Wencheng travelled west from Chang'an to marry into Tibet, and the road she took has carried that name ever since. For two centuries afterwards the traffic never stopped: between 634 and 850, Tibetan missions reached the Tang court 125 times and Tang missions went to Tibet 65 times. Tea, silk, sutras, craftsmen and horses all crossed at this river's fords.", "641年、文成公主は長安から西へ、吐蕃へ嫁ぐ道を行った。その和親の道が「唐蕃古道」の名で後世に伝わる。以後二百余年、使節の往来は絶えなかった。634年から850年のあいだに吐蕃の使節は一二五回唐を訪れ、唐の使節は六五回吐蕃へ赴いた。茶、絹、経巻、職人、そして馬。すべてがこの川の渡し場を越えていった。"),
      ],
      culture: [
  ...
  "wuhan": {
    facets: {
      nature: [
        l("汉水在龟山脚下注入长江，一刀把城切成三块：汉口、汉阳、武昌。全市水域两千两百多平方公里，占市域四分之一强，其中湖泊八百余平方公里；大小湖泊一百六十六个，仅中心城区就占四十三个，「百湖之市」并非夸口。", "The Han River joins the Yangtze under Tortoise Hill and cuts the city into three: Hankou, Hanyang, Wuchang. Water covers more than a quarter of Wuhan — over 2,200 square kilometres, of which some 800 are lake. There are 166 of them, 43 inside the central districts alone. \"City of a hundred lakes\" is if anything an undercount.", "漢水は亀山のふもとで長江に合流し、街を一刀のもとに三つに分ける——漢口・漢陽・武昌。市域の四分の一を超える二二〇〇平方キロ余りが水面で、うち湖沼が八〇〇平方キロ。大小あわせて一六六の湖があり、中心市街だけでも四三を数える。「百湖の市」は誇張ではない。"),
        l("这些湖多半是长江自己留下的：主泓摆动、泥沙封口，旧河道就成了湖。东湖水域三十三平方公里，岸线115.5公里；1899至1902年张之洞在此修堤建闸，才把东湖与周边湖群同长江彻底分开，水患不再顺江直灌。", "Most of them were made by the river itself: the main channel wandered, silt sealed an old bend, and what was left behind became a lake. East Lake covers 33 square kilometres with 115.5 kilometres of shore; only when Zhang Zhidong built dykes and sluices between 1899 and 1902 was it, with the lakes around it, finally severed from the Yangtze — and the floods stopped coming in through the front door.", "その多くは長江自身がこしらえたものだ。本流が振れ、土砂が旧河道の口を塞ぎ、取り残された水がそのまま湖になる。東湖は水面三三平方キロ、岸線一一五・五キロ。1899年から1902年にかけて張之洞が堤と水門を築き、周囲の湖群ともども、ようやく長江から切り離された。"),
