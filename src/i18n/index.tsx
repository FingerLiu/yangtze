...
export const UI = {
  ...
  kgRelated: l('关联', 'Connections', 'つながり'),
  kgOpenSite: l('查看这一站的详情', 'Open this stop', 'この地の詳細へ'),
  kgHint: l(
    '拖动平移、滚轮缩放；点击节点看它的关联，搜索可定位',
    'Drag to pan, scroll to zoom · Click a node for its connections, or search',
    'ドラッグで移動、ホイールで拡大 ・ ノードをクリックでつながりを表示',
  ),
